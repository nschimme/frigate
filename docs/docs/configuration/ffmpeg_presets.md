...
| preset-record-generic-audio-faac | Record (Generic + Audio via FAAC) | Record with audio transcoded via FAAC | Transcodes audio using FAAC encoder for higher quality AAC at lower bitrates |
